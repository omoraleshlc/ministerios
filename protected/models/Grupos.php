 ...
 * @property integer $keyGrupos
 * @property string $descripcion
 * @property string $nombreLider
...
class Grupos extends CActiveRecord
{
	...
	{
		return array(
			'keyGrupos' => 'Key Grupos',
			'descripcion' => 'Descripcion',
			'nombreLider' => 'Nombre Lider',
			'fecha' => 'Fecha',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('keyGrupos',$this->keyGrupos);
		$criteria->compare('descripcion',$this->descripcion,true);
		$criteria->compare('nombreLider',$this->nombreLider,true);
